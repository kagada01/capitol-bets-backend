...
bet1 = Bet.create!(game_id: game2.id, user_id: user1.id, payout: 500, bet_taker_id: user2.id, money_line_odds: 110, wager_amount: 75, winner_id: user1.id)
bet2 = Bet.create!(game_id: game4.id, user_id: user2.id, payout: 500, bet_taker_id: user1.id, money_line_odds: 250, wager_amount: 25, winner_id: user2.id)
